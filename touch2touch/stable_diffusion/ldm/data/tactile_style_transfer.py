...
class TactileStyleTransferBase(Dataset):
    ...
    def __getitem__(self, i):
        ...
        assert bubble.max() <= 1 and bubble.min() >= -1, print(bubble.max(), bubble.min())
...
class TactileStyleTransferTrain(TactileStyleTransferBase):
    def __init__(self, flip_p=0., **kwargs):
        super().__init__(json_file="/home/samanta/stable-diffusion/data/tactile_style_transfer/split.json",
                         data_root="/home/samanta/stable-diffusion/data/tactile_style_transfer", flip_p=flip_p, set_type='train',  **kwargs)


class TactileStyleTransferValidation(TactileStyleTransferBase):
    def __init__(self, flip_p=0., **kwargs):
        super().__init__(json_file="/home/samanta/stable-diffusion/data/tactile_style_transfer/split.json",
                         data_root="/home/samanta/stable-diffusion/data/tactile_style_transfer", flip_p=flip_p, set_type='val',  **kwargs)


class TactileStyleTransferTest(TactileStyleTransferBase):
    def __init__(self, flip_p=0., **kwargs):
        super().__init__(json_file="/home/samanta/stable-diffusion/data/tactile_style_transfer/split_new_test.json",
                         data_root="/home/samanta/stable-diffusion/data/tactile_style_transfer", flip_p=flip_p, set_type='test',  **kwargs)
